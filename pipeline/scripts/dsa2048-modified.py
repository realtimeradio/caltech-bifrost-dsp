...
def build_pipeline(args):
    ...
    from lwa352_pipeline.blocks.corr_romein import Corr_Romein
    print('Done')
    ...
    if not (args.nocorr or args.nogpu):
        ops.append(Corr_Romein(log, iring=gpu_input_ring, oring=corr_output_ring, conv=5, grid=4096, ntime_gulp=GSIZE,
